...
public class WizardTower extends Building{
    ...
    private ArrayList<ImageView>fire=new ArrayList<>();
    public WizardTower(   double x, double y) {
        super(BuildingKind.Defensive, 20000, 95, 100, x, y, new ImageView(new Image(Main.class.getResource("Images/wizard_tower_15.png").toString())));
    }

    public WizardTower( double x, double y,ImageView fire) {
        super(BuildingKind.Defensive, 20000, 95, 100, x, y, new ImageView(new Image(Main.class.getResource("Images/wizard_tower_15.png").toString())));
        initFire();
        this.setCurrentImage(fire);
    }
...
//                Thread.sleep(10);
    ...
    {
        getFire().add(new ImageView(new Image(Main.class.getResource("Images/fire/1.png").toString())));
    }
}
